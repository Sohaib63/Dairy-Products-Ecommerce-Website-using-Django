...
class checkout(View):
    def get(self, request):
        ...
        #{'id': 'order_L9a6KC9zRBe73a', 'entity': 'order', 'amount': 74000, 'amount_paid': 0,
        #'amount_due': 74000, 'currency': 'INR', 'receipt': 'order_rcptid_12', 'offer_id': None, 
        #'status': 'created', 'attempts': 0, 'notes': [], 'created_at': 1674905415}
